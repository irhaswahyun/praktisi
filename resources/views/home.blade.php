    ...
    <div class="container bg-light p-5" style="border-radius: 20px;">
        <div class="row my-5">
            <div class="col-md-6 d-flex align-items-center">
                <div>
                    <h2>Selamat Datang di Perpustakaan <br><b>Rumah Buku</b></h2>
                    <p class="text-secondary">Rumah untuk para insan penggemar membaca buku, <br>Gabunglah Bersama Kami! Agar Anda Dapat Membaca Buku Kapanpun</p>
